function [reach_dest, setout] = sed_transfer_fast(n , v_sed_day , Lngt, Network )
...
% this version is used in the DCASCADE_3S_sedyield function
...
%     
% for c=1:size(v_sed_day,1)
%     Qbi_tr_t(:,:,c) = V_mob(:,c) .* setplace(c,:);
% end
%    
% Q_out_t = V_mob .* setout';
